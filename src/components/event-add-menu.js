...
const createEventAddMenu = (routeData) => {
  ...
  <header class="event__header">
    <div class="event__type-wrapper">
      <label class="event__type  event__type-btn" for="event-type-toggle-1">
        ...
        <img class="event__type-icon" width="17" height="17" src="${waypoint.iconPath}" alt="Event type icon">
      </label>
  ...
  <section class="event__details">
    ...
    <section class="event__section  event__section--offers">
      ...
      ${extraServices.map((type) => {
    return `<div class="event__offer-selector">
          <input class="event__offer-checkbox  visually-hidden" id="event-offer-${type.additionalName}-1" type="checkbox" name="event-offer-${type.additionalName}" ${type.checked === true ? `checked` : ``}>
...
export default class EventAddMenu extends AbstractSmartComponent {
